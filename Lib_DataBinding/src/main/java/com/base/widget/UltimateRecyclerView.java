...
import com.marshalchen.ultimaterecyclerview.UltimateRecyclerView.CustomRelativeWrapper;
...
public class UltimateRecyclerView extends FrameLayout implements Scrollable {
    ...
    protected void initViews() {
        ...
        View view = inflater.inflate(com.base.databinding.R.layout.ultimate_recycler_view_layouts, this);
        mRecyclerView = (SwipeMenuRecyclerView) view.findViewById(com.base.databinding.R.id.ultimate_list);
        mSwipeRefreshLayout = (VerticalSwipeRefreshLayout) view.findViewById(com.base.databinding.R.id.swipe_refresh_layout);
        setScrollbars();
        ...
        defaultFloatingActionButton = (FloatingActionButton) view.findViewById(com.base.databinding.R.id.defaultFloatingActionButton);
        setDefaultScrollListener();

        /**
         * empty view setup
         */
        mEmpty = (ViewStub) view.findViewById(com.base.databinding.R.id.emptyview);
        if (mEmptyId != 0) {
         ...
         */
        mFloatingButtonViewStub = (ViewStub) view.findViewById(com.base.databinding.R.id.floatingActionViewStub);
    ...
    public void setLoadMoreView(View mlayoutView) {
        ...
        if (mlayoutView == null) {
            mLoadMoreView = LayoutInflater.from(getContext())
                                          .inflate(com.base.databinding.R.layout.bottom_progressbar, null);
    ...
    protected void setScrollbars() {
        ...
        switch (mScrollbarsStyle) {
            case SCROLLBARS_VERTICAL:
                ...
                View verticalView = inflater.inflate(com.base.databinding.R.layout.vertical_recycler_view, mSwipeRefreshLayout, true);
                mRecyclerView = (SwipeMenuRecyclerView) verticalView.findViewById(com.base.databinding.R.id.ultimate_list);
                break;
            case SCROLLBARS_HORIZONTAL:
                mSwipeRefreshLayout.removeView(mRecyclerView);
                View horizontalView = inflater.inflate(com.base.databinding.R.layout.horizontal_recycler_view, mSwipeRefreshLayout, true);
                mRecyclerView = (SwipeMenuRecyclerView) horizontalView.findViewById(com.base.databinding.R.id.ultimate_list);
                break;
            default:
                break;
        }
    ...
    private void scroll_load_more_detection(RecyclerView recyclerView) {
        ...
        if (bottomEdgeHit) {
            if (mIsLoadMoreWidgetEnabled) {
                ...
                if (!automaticLoadMoreEnabled) {
                    onLoadMoreListener.loadMore(mRecyclerView.getAdapter()
...
//                    todo: 07-01 11:50:36.359  32348-32348/com.marshalchen.ultimaterecyclerview.demo D/RVerror? Attempt to invoke virtual method 'int android.view.View.getHeight()' on a null object reference
    ...
    /**
     * Set a SwipeMenuAdapter or the subclass of SwipeMenuAdapter to the recyclerview
     *
    ...
    public void setParallaxHeader(@LayoutRes int mLayout) {
        View h_layout = LayoutInflater.from(getContext())
    ...
    protected void moveToolbar(final Toolbar mToolbar, final UltimateRecyclerView ultimateRecyclerView, final int screenheight, float toTranslationY) {
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(ViewCompat.getTranslationY(mToolbar), toTranslationY)
                                              .setDuration(200);
    ...
    protected void moveView(final View mView, final UltimateRecyclerView ultimateRecyclerView, final int screenheight, float toTranslationY) {
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(ViewCompat.getTranslationY(mView), toTranslationY)
                                              .setDuration(200);
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
