...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PhotoAdapter(Context context, ArrayList<String> imageses, int spancount, int chosemode) {
        ...
        hashmap = ((MediaChoseActivityGallery) context).getImageChoseMap();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_CAMERA) {
            holder = new CameraViewHolder(
                inflater.inflate(R.layout.item_photo_camera_layout, parent, false));
        } else {
            holder = new ImageViewHolder(
                inflater.inflate(R.layout.item_photo_image_layout, parent, false));
        }
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == TYPE_IMAGE) {
            ...
            final String images = getDir() + imageses.get(position - 1);
                    ...
                    public void onClick(View v) {
                        if (hashmap.containsKey(images)) {
                            ...
                            if (hashmap.size() >= max_chose_count) {
                                Toast.makeText(context, "你最多只能选择" + max_chose_count + "张照片",
...
//                        ((Activity) context).invalidateOptionsMenu();
                        ((MediaChoseActivityGallery) context).notifySelectedTInfo();
                    }
                });
                if (hashmap.containsKey(images)) {
                    ivholder.alpha_view.setVisibility(View.VISIBLE);
                ...
                ivholder.iv_image.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((MediaChoseActivityGallery) context).starPriview(getChoseImages(), images,
                                                                          imageses);
                    }
                });
            } else {
                ...
                ivholder.iv_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ((MediaChoseActivityGallery) context).sendImages();
//                        ((MediaChoseActivityGallery) context).starPriview(getChoseImages(), images);
                    }
                });
            }
                ...
                public void onClick(View v) {
                    if (currentChoseMode == PickConfig.MODE_MULTIP_PICK) {
                        if (getChoseImages().size() < max_chose_count) {
                            ((MediaChoseActivityGallery) context).sendStarCamera();
                        } else {
                            Toast.makeText(context, "你最多只能选择" + max_chose_count + "张照片",
                                           Toast.LENGTH_SHORT).show();
                        }
    ...
    public void displayImage(String url, ImageView view) {
        Glide.with(context).load(url).
            centerCrop()
             .crossFade()
             .override(sWidthPix / spancount / 2, sWidthPix / spancount / 2)
    ...
    public void setImageses(ArrayList<String> imageses) {
        this.imageses = imageses;
